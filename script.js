document.addEventListener('DOMContentLoaded', () => {
    ...
    function shareResume() {
        ...
        const shareableLink = `${window.location.origin}/resume/${uniqueId}`; // Corrected template literal
        alert(`Share this link: ${shareableLink}`); // Corrected alert statement
    }
    ...
    // Check if we're on a shared resume page
